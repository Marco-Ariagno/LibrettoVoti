...
public class TestLibretto {
	...
	private void run() {
		...
		// 3. Cerca esame superato, conoscendo il nome del corso
		...
		// dovrei anche fare la prova per il voto mancante
		...
		System.out.println("Economia con 24 e' duplicato: " + lib.isDuplicato(economia2) + "/ conflitto: "
				+ lib.isConflitto(economia2));
		System.out.println("Economia con 24 e' duplicato: " + lib.isDuplicato(economia3) + "/ conflitto: "
